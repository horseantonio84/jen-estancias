...
const CHARACTERS = [
  ...
  },
  {
    ...
    images: [
      { file: 'Rodrigo_planoCara.png',                  label: 'Cara — Frontal'          },
      { file: 'Rodrigo_planoCaraLadoDerecho.png',       label: 'Cara — Derecha'          },
      { file: 'Rodrigo_planoCaraLadoDerechoAlante.png', label: 'Cara — Derecha Adelante' },
      { file: 'Rodrigo_planoCaraLadoDerechoAtras.png',  label: 'Cara — Derecha Atrás'   },
      { file: 'Rodrigo_planoCuerpoAlante.png',          label: 'Cuerpo — Frontal'        },
      { file: 'Rodrigo_planoCuerpoAtras.png',           label: 'Cuerpo — Trasero'        },
      { file: 'Rodrigo_planoCuerpoLadoDerecho.png',     label: 'Cuerpo — Derecho'        },
      { file: 'Rodrigo_planoCuerpoLadoIzquierdo.png',   label: 'Cuerpo — Izquierdo'      },
    ],
  },
  {
